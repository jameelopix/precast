...
public class ItemController {
    ...
    public ItemClientModel createItem(@Valid @RequestBody ItemClientModel itemClientModel) {
        return this.constructClientModel(itemService.createItem(this.constructServiceRequest(itemClientModel)));
    }

    @RequestMapping(value = "updateItem", method = RequestMethod.POST)
    @ResponseBody
    public ItemClientModel updateItem(@Valid @RequestBody ItemClientModel itemClientModel) {
        return this.constructClientModel(itemService.updateItem(this.constructServiceRequest(itemClientModel)));
    }

    @RequestMapping(value = "getItem", method = RequestMethod.POST)
    @ResponseBody
    public ItemClientModel getItem(@RequestBody ItemClientModel itemClientModel) {
        return this.constructClientModel(itemService.getItems(this.constructServiceRequest(itemClientModel)));
    }

    private ItemClientModel constructClientModel(ItemServiceResponse itemServiceResponse) {
        ItemClientModel itemClientModel = null;
        if (itemServiceResponse != null) {
            itemClientModel = new ItemClientModel();
            itemClientModel.setItemDTOList(itemServiceResponse.getItemDTOList());
            itemClientModel.setTotalRecords(itemServiceResponse.getTotalRecords());
        }
